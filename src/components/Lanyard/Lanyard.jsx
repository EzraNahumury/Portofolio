...
import ezraCard from '../../assets/Lanyard/ezra.png';
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const cardTexture = useTexture(ezraCard);
  ...
  // Gunakan Planar Mapping berdasarkan posisi vertex agar texture pas di tengah
  const cardGeometry = useMemo(() => {
    ...
    // 1. Cari bounding box POSISI (bukan UV lama)
    ...
    if (rangeX > 0 && rangeY > 0) {
      for (let i = 0; i < uv.count; i++) {
        ...
        // Gunakan 1 - y jika texture terbalik
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            <mesh geometry={cardGeometry}>
              <meshPhysicalMaterial map={cardTexture} map-anisotropy={16} clearcoat={0.5} clearcoatRoughness={0.15} roughness={0.5} metalness={0.1} />
            </mesh>
